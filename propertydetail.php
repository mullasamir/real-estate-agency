...
<!-- Meta Tags --><!--Developed by Samir :@the_sam_sm -->
<meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<!--	Title
	=========================================================-->
<title>Real Estate Agency - Property-details</title>
</head>
<body>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                <div class="row"><!--Developed by Samir :@the_sam_sm -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            ...
                            <div  class="table-striped font-14 pb-2">
                                <table class="w-100"><!--Developed by Samir :@the_sam_sm -->
                                    <tbody>
                                        <tr>
                                            <td>BHK :</td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 col-lg-9">
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            <h6 class="text-success text-capitalize">Name : <?php echo $row['uname'];?></h6>
                                            <ul class="mb-3">
                                                <li>Contact-no : <?php echo $row['uphone'];?></li>
                                                <li>Email : <?php echo $row['uemail'];?></li>
												<li>Role : <?php echo $row['utype'];?></li>
                                            </ul>
