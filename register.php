...
if(isset($_REQUEST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage))
		{
			...
			$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage,uaddress) VALUES ('$name','$email','$phone','$pass','$utype','$uimage','$address')";
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Header end  --><!--Developed by Samir :@the_sam_sm -->
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form method="post" enctype="multipart/form-data">
									...
									</div><!--Developed by Samir :@the_sam_sm -->
									<div class="form-check-inline">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="engineer">Engineer
									  </label>
									</div>
									...
									<div class="form-check-inline disabled">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="shop-keeper">Shop-keeper
									  </label>
									</div>
									<div class="form-check-inline disabled">
									  <label class="form-check-label">
										<input type="radio" class="form-check-input" name="utype" value="worker">Worker
									  </label>
									</div> 
