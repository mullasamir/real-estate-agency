							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM user WHERE utype = 'builder'";
										...
										<h6 class="text-muted"><a href="userbuilder.php">Registered Builder</a></h6>
										<div class="progress progress-sm">
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM user WHERE utype = 'engineer'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
										
										<h6 class="text-muted"><a href="englist.php">Registered Engineer</a></h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-success w-50"></div>
										</div>
									</div>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM user WHERE utype = 'shop-keeper'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
										
										<h6 class="text-muted"><a href="shoplist.php">Registered Shops</a></h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-success w-50"></div>
										</div>
									</div>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM user WHERE utype = 'worker'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
										
										<h6 class="text-muted"><a href="workerlist.php">Registered Worker</a></h6>
										<div class="progress progress-sm">
