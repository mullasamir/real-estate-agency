...
<!--	Title
	=========================================================-->
<title>Real Estate Agency - Home</title>
</head>
<body>
...
<div id="page-wrapper">
    <div class="row"> 
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            ...
                            Guide you Home</h1><!--Developed by Samir :@the_sam_sm -->
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!--Developed by Samir :@the_sam_sm -->
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p align="justify">We offrers you various properties in different statets at affordable cost.. </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p align="justify">We provide you a various rental services and we have multiple rental dealers / agents.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p align="justify">Properties are available at different places and in popular cities of Maharashtra.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Find ur Dream Home</a></h5>
                                <p> Hurryy..up !! <br>Join us to find your dream home...</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12"><!--Developed by Samir :@the_sam_sm -->
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4"><!--Developed by Samir :@the_sam_sm -->
                                        <div class="featured-thumb hover-zoomer mb-4">
          <div class="overlay-black overflow-hidden position-relative"> 
		  <img src="admin/property/<?php echo $row['18'];?>" alt="pimage" height="230px" width="180px">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Our top-rated real estate services are a testament to our unwavering commitment to excellence, providing clients with exceptional experiences and results in every transaction."</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Our commitment to experience quality sets us apart, delivering top-notch service backed by years of industry knowledge, providing our clients with confidence and satisfaction in every real estate endeavor."</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>"Trust in the hands of our seasoned real estate agents, where experience is not just a trait but a cornerstone of our commitment to delivering excellence and exceeding client expectations."</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p align="justify">
"Engage in vibrant discussions on our real estate platform, where community members share insights, ask questions, and connect over all things related to homes, neighborhoods, and property trends."</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p align="justify">"Explore firsthand experiences through our client reviews, showcasing satisfaction and success stories that attest to our commitment to excellence in real estate services."</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p align="justify">"Acquire your dream property seamlessly with our expert guidance and personalized support."</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='kolhapur'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Ichalkaranji'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['16']?>"><?php echo $row['city'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1"><!--Developed by Samir :@the_sam_sm -->
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Satara'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['16']?>"><?php echo $row['city'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Karad'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['16']?>"><?php echo $row['city'];?></a></h4>
