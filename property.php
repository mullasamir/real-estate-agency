...
<!--	Title
	=========================================================-->
<title>Real Estate Agency - Properties</title>
</head>
<body>
                ...
                <div class="row">
					...
					<div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['0'];?>"><u><?php echo $row['1'];?></a></u></h5>
                            ...
                            <?php } ?><!--Developed by Samir :@the_sam_sm -->
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget"><!--Developed by Samir :@the_sam_sm -->
