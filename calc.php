...
if(isset($_REQUEST['calc']))
{
	...
	//$interest = $amount * $int/100 * $month;
	//$pay = $amount + $interest;
	//$month = $pay / $mon;
	$interest = $amount * $int * $mon / 100;
	$pay = $amount + $interest;
	$month = $pay / $mon;
	$m = $month / 12;
...
<!--	Title
	=========================================================-->
<title>Real Estate Agency - EMI-Cal</title>
</head>
<body>
            ...
            <div class="container">
					...
					<table class="items-list col-lg-6 table-hover" style="border-collapse:inherit;">
                        ...
                        <tbody>
                            ...
                            </tr><!--Developed by Samir :@the_sam_sm -->
							<tr class="text-center">
							...
							<tr class="text-center">
                                ...
                                <td><b><?php echo '₹'.number_format($m ,2) ; ?></b></td>
                            </tr>
