...
<!--	Title
	=========================================================-->
<title>Real Estate Agency - Shop</title>
</head>
<body>
    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
				<div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Shop</h2>
                        </div>
                </div>
                <div class="row">
                <!--Developed by Samir :@the_sam_sm -->
                    <?php 
							$query=mysqli_query($con,"SELECT * FROM user WHERE utype='shop-keeper'");
                        ...
                        <div class="hover-zoomer bg-white shadow-one mb-4">
                            ...
                            <div class="py-3 text-center">
                             ...
                             <h5 class="text-secondary hover-text-success"><a href="#">Address : <?php echo $row['7'];?></a></h5>
                                <span>Real Estate - Shop</span> </div>
                        </div>
                    </div>
